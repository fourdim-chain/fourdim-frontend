  ...
  return useRoutes([
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'nft',
          children: [{ path: 'nft-multi-transfer', element: <NftMultiTransfer /> }],
        },
        {
          path: 'user',
          children: [
...
// token
const SingleTokenMultiTransfer = Loadable(
  lazy(() => import('../pages/token/SingleTokenMultiTransfer'))
);
const SingleAddressMultiTransfer = Loadable(
  lazy(() => import('../pages/token/SingleAddressMultiTransfer'))
);
const MultiAccountTokenTransfer = Loadable(
  lazy(() => import('../pages/token/MultiAccountTokenTransfer'))
);
